...
public class MyRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(
        ...
        if (!"admin".equals(username)) {
            user = userService.login(new User(username));
            simpleAuthenticationInfo = new SimpleAuthenticationInfo(user.getName(), user.getPassword(), getName());
        } else {
            admin = adminService.login(new Admin(username));
            simpleAuthenticationInfo = new SimpleAuthenticationInfo(admin.getName(), admin.getPassword(), getName());
        }
