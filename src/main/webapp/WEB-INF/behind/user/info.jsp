...
<!-- Left side content -->
<div id="leftSide">
    <div class="logo"><a href="${pageContext.request.contextPath}/common/index"><img src="${pageContext.request.contextPath}/resources/behind/images/logo.png" alt="" /></a></div>
                ...
                <ul>
                    <li class="dd"><a href="#" title=""><img src="${pageContext.request.contextPath}/resources/behind/images/icons/topnav/profile.png" alt="" /><span>Profile</span><span class="numberTop">2</span></a>
						<ul class="userDropdown">
                            <li><a href="${pageContext.request.contextPath}/" title="" class="sAdd">查看账号信息</a></li>
        ...
        <form id="validate" class="form" method="post" action="">
        	<fieldset>
                <div class="widget">
                    <div class="formRow">
                        <label>账号:</label>
                        <div class="formRight"><input disabled="disabled" type="text" value="${user.name}" name="name" id="name"/></div><div class="clear"></div>
                    </div>

					<div class="formRow">
                        <label>邮箱:</label>
                        <div class="formRight"><input disabled="disabled" type="text" value="${user.email}"/></div>
                        <div class="clear"></div>
                    </div>
                    
					<div class="formRow">
                        <label>手机号:</label>
                        <div class="formRight"><input disabled="disabled" type="text" value="${user.phone}"/></div>
                        <div class="clear"></div>
                    </div>

                    <a class="button dredB" href="${pageContext.request.contextPath}/film/user/list">
                        <span>返回后台主页</span>
                    </a>
                    <div class="clear"></div>
                </div>
