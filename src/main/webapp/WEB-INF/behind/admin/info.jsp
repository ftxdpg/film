...
<div id="rightSide">
    ...
    <div class="topNav">
        <div class="wrapper">
            ...
            <div class="userNav">
                <ul>
                    <li class="dd"><a href="#" title=""><img src="${pageContext.request.contextPath}/resources/behind/images/icons/topnav/profile.png" /><span>Profile</span><span class="numberTop">2</span></a>
						<ul class="userDropdown">
                            <li><a href="${pageContext.request.contextPath}/film/admin/info" class="sAdd">查看账号信息</a></li>
                            <li><a href="${pageContext.request.contextPath}/admin/update" class="sInbox">更改账号信息</a></li>
                        </ul>
					</li>
