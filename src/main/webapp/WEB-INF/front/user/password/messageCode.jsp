...
<body>
    <div class="wrapper">
        ...
        <!-- Main content -->
        <form id="phone-form" class="login" method="post" novalidate='' style="margin-top: 100px;" action="${pageContext.request.contextPath}/common/inputPhoneCode">
            ...
            <p class="login__title">请输入短信验证码</p>
            <div class="field-wrap">
                <input placeholder='手机验证码' id="code" name='code' class="login__input" style="width: 190px;">
                <input type='button' id="getCode" class="btn btn-md btn--warning btn--wider" onclick="send()" value="获取验证码">
    ...
    <script type="text/javascript">
        ...
        function send() {
            $.ajax({
                ...
                type:"post",
                data:{"phone":${sessionScope.forgetUserByPhone.phone}},
