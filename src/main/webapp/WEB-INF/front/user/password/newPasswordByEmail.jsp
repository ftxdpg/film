...
<body>
    <div class="wrapper">
        ...
        <!-- Main content -->
        <form id="submit-form" class="login" method="post" novalidate='' style="margin-top: 100px;" action="${pageContext.request.contextPath}/common/inputNewPasswordByEmail">
