...
<body>
    <div class="wrapper">
        ...
        <form id="login-form" class="login" method='get' novalidate='' style="margin-top: 100px;">
            ...
            <a href="${pageContext.request.contextPath}/user/messageReg" class="login__tracker form__tracker" style="padding-left: 190px; margin-top: -46px;">短信注册<br></a>
            <div class="field-wrap">
                ...
                <input placeholder='邮箱验证码' name='code' class="login__input" style="width: 190px;">
            ...
            <div class="login__control">
                ...
                <a href="${pageContext.request.contextPath}/user/loginUI" class="login__tracker form__tracker">已有账号？在这登录</a>
            </div>
        </form>
