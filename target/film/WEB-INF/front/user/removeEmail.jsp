...
<body>
    <div class="wrapper">
        ...
        <!-- Main content -->
        <form id="email-form" class="login" method="post" novalidate='' style="margin-top: 100px;" action="${pageContext.request.contextPath}/film/user/removeEmail">
            ...
            <p class="login__title">解除绑定邮箱</p>
            <div class="field-wrap">
                <input type='email' placeholder='邮箱' name="email" id='email' class="login__input" onblur="sendEmail()"><i id="iEmail" class=""></i>
