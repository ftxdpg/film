...
<body>
    <div class="wrapper">
        ...
        <!-- Main content -->
        <form id="submit-form" class="login" method="post" novalidate='' style="margin-top: 100px;" action="${pageContext.request.contextPath}/common/inputNewPasswordByPhone">
            ...
            <p class="login__title">短信修改密码</p>
            <div class="field-wrap">
                <input type='password' placeholder='密码' name="password" id='password' class="login__input">
            </div>
            <div class="login__control">
                <button type='submit' class="btn btn-md btn--warning btn--wider">保存密码</button>
            </div>
        </form>
