...
<body>
    <div class="wrapper">
        ...
        <!-- Main content -->
        <form id="phone-form" class="login" method="post" novalidate='' style="margin-top: 100px;" action="${pageContext.request.contextPath}/common/forgetPasswordByPhone">
            ...
            <p class="login__title">短信找回</p>
            <div class="field-wrap">
                <input placeholder='账号' id="name" name='name' class="login__input">
                <input placeholder='手机号' id="phone" name='phone' class="login__input">
            </div>
