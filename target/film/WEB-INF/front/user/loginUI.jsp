                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <div class="auth auth--home" style="top: -8px; margin-top: 1px; left: -100px;">
                                <a href="${pageContext.request.contextPath}/user/emailReg" class="btn btn--sign" style="top: 5px;">注册</a>
                            </div>
                        </c:otherwise>
                    </c:choose>
        ...
        <!-- Main content -->
                <form id="login-form" class="login" method='get' novalidate='' style="margin-top: 100px;">
                    ...
                    <div class="field-wrap">
                        <input type='email' placeholder='Account' name='user-email' class="login__input">
                    ...
                    <div class="login__control">
                        ...
                        <a href="${pageContext.request.contextPath}/user/emailReg" class="login__tracker form__tracker">没有账号？现在注册一个</a>
                    </div>
                </form>
